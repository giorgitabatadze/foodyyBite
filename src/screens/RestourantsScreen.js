...
const RestourantsScreen = ({ navigation, route }) => {
		...
		<SafeView>
			<View style={styles.container}>
				<View style={styles.header}>
					...
					>
						<CustomText style={styles.headerTitle}>{Trending}</CustomText>
					</View>
				</View>
				...
				<FlatList
					...
					data={searchValue?.length == null ? data : searchValue}
...
export default RestourantsScreen;
